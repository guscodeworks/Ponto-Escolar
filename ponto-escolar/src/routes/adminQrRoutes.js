...
router.patch('/:id/desativar', sensitiveLimiter, qrShortcutIdParamValidator, deactivateQrShortcut);
router.post('/validar', sensitiveLimiter, validateQrShortcutValidator, validateQrShortcut);
